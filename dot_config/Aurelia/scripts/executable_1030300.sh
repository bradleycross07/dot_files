#!/usr/bin/env bash
# Aurelia per-game launch script for app 1030300 (Hollow Knight: Silksong).
#
...
#   AURELIA_APP_ID        - the Steam app id (1030300)
...
exec "$HOME/.local/bin/discord-rpc-wrap" 1413176957381771337 \
     gamescope -w 1600 -h 900 -W 1600 -H 900 -r 144 -f -- mangohud "$@"
